...
export class ChefsComponent implements OnInit {
  ...
  chefs = [
    {
      image: 'http://jgarnerphoto.com/_uploads/images/gallery/rainier-club/_galleryThumb/RC_CHEF_165-professional-photography-lifestyle-photographer.jpg',
      name: 'Angel Siderov',
      job: 'Main Chef',
      description:
